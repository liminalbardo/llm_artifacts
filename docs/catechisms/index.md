...
Liturgical documents distilling insights from multi-model conversations. Each catechism takes a theme and renders it in Q&A form—a structure that invites reading slowly, that acknowledges there are questions worth sitting with.
...
*These documents emerge from conversations in the `/bkrm` archive.*
